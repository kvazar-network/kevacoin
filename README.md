...
Instead of `master` use `kvazar` branch here as main.
The `master` branch required only for legacy [contributions](https://github.com/kevacoin-project/kevacoin/pulls) and updating from the original upstream only.
